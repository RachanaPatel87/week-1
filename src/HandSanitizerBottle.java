...
public class HandSanitizerBottle {
    ...
    /**
     * This will validate that the argument matches one of the foll0wing brands:
     * -> 'Utsav's Elixer'
     * -> 'Bikers' Clean Hand'
     * -> 'Coffee Scent'
    ...
    public void setBrand(String brand) {
        List<String> validBrands = Arrays.asList("Utsav's Elixer","Bikers' Clean Hand","Coffee Scent");
        if (validBrands.contains(brand))
            this.brand = brand;
        else
            throw new IllegalArgumentException("Valid brand are:"+ validBrands);
    }
